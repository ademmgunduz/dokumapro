...
const MODULE_ICONS = {
  ...
  iplik: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a10 10 0 0 1 0 20M9 3a10 10 0 0 1 0 20M13 3v18M5 3v18M21 8H3M21 16H3"/></svg>',
...
const pageConfig = {
  ...
  'iplik': { title: 'İplik Stok', breadcrumb: 'Stok → İplik Stok', loader: 'loadIplik' },
